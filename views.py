    ...
    if request.method == 'POST':
        ...
        if valid == True:            
            ...
            yag.send(to=email, subject='Activa tu cuenta',
                     contents='Bienvenido '+name+', usa este vínculo para activar tu cuenta: https://grupob.fcimec.org/validacion/'+ str (nuevoUsuario.validacion) )
...
def recuperarPassword():
    ...
    if request.method == 'POST':
        ...
        if valid == True:
            ...
            yag = yagmail.SMTP('uninortegrupo9b@gmail.com', 'unigrupob')
            yag.send(to=email, subject='Activa tu cuenta',
                     contents='Bienvenido, usa este vínculo para recuperar  tu contraseña: https://grupob.fcimec.org/recuperar/'+str(usuario.validacion))
            return verificarCorreo()
        else:
            flash('Correo inválido')
